  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        ...
        className="w-full bg-stone-900 text-white py-3 rounded-xl font-medium hover:bg-stone-800 active:scale-[0.98] transition-all duration-200 text-sm disabled:opacity-50"
      >
    ...
    <>
        ...
        <nav className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-sm bg-stone-900 text-white px-4 py-1.5 rounded-full hover:bg-stone-800 active:scale-95 transition-all duration-200"
            >
              Anfrage senden
            </button>
      ...
      <main className="pt-14">
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 pb-20 w-full">
            ...
            <div className="animate-fade-up mt-8 flex flex-wrap gap-4" style={{ animationDelay: "0.56s" }}>
              <button
                onClick={() => setModalOpen(true)}
                className="bg-stone-900 text-white px-6 py-3 rounded-full font-medium hover:bg-stone-800 active:scale-95 transition-all duration-200"
              >
                Jetzt anfragen
              </button>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {FEATURES.map((f, i) => (
                ...
                >
                  <span className="text-stone-400 mb-4 block group-hover:text-stone-900 transition-colors duration-300">
                    {f.icon}
                  </span>
        ...
        <section id="galerie" className="py-24 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            <p className="reveal text-stone-500 text-sm uppercase tracking-widest mb-2">Galerie</p>
